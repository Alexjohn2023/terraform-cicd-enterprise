...
This is part of a growing enterprise DevOps portfolio:

- ✅ **Project 6** — Remote Terraform CI/CD with GitHub Actions (this project)
- 🔄 **Project 7** — Jenkins parallel pipeline for regulated environments
- 📋 **Project 8** — Docker + ECR containerization pipeline
- 📋 **Project 9** — Ansible configuration management
- 📋 **Project 10** — Prometheus + Grafana monitoring stack
- 📋 **Project 11** — Kubernetes + EKS with CKA certification prep
